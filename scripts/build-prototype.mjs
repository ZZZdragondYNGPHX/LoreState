...
const pieces=await Promise.all(['modules','core','entity-delete','template-display','template','presets','builtin-preset','ui-kit','api-profiles','appearance-authoring','appearance-panel','api-panel','extra-update','control-center','state-frame','snapshots','snapshot-store','ejs-bridge','runtime'].map(name=>read(`prototype/${name}.js`)));
